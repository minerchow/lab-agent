...
from crud.lab import get_lab_page_list, create_lab, update_lab, delete_lab
...
async def list_labs(
    ...
    labs, total = await get_lab_page_list(db, page, page_size, keywords)
